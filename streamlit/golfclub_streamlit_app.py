...
if check_password():
    ...
    monat = col2.selectbox(
        "Monat", ["Alle", "Apr", "Mai", "Jun", "Jul", "Aug", "Sep", "Okt"]
    )
    ...
    data_to_show = col3.selectbox(
        "Data to show",
        [
            "Auslastung Gesamt",
            "Auslastung Gäste",
            "Auslastung MGL Gesa.",
            "Auslastung MGL Jugend",
            "Auslastung MGL 18-40",
            "Auslastung MGL 40-50",
            "Auslastung MGL 50-65",
            "Auslastung MGL 65+",
        ],
    )
    ...
    plot_data = plot_data[
        (plot_data["time"] >= startzeit) & (plot_data["time"] <= endzeit)
    ]
